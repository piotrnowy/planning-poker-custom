          ...
          {isMod && (
            <>
              ...
              >
                <AlertDialog
                  id={game.id}
                  message='Are you sure you want to delete this session? This will remove all players from the session.'
      ...
      {showCopiedMessage && (
        <div className='fixed top-6 right-6 z-50'>
          <div
            ...
            role='alert'
          >
            <span className='block font-bold'>Invite link copied!</span>
          </div>
        </div>
      )}
    </div>
